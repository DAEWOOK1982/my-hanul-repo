...
<%@page import="com.hanul.dto.TestAnswerDTO"%>
...
TestAnswerDTO dto = (TestAnswerDTO) request.getAttribute("dto");
...
<table border="1" style="width: 70%;">
	...
	<tr align="center">
		<td colspan="12">총 점 : ${score}&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			<c:choose>
				<c:when test="${score >= 60}"> 합격 </c:when>
				<c:when test="${score < 60 }"> 불합격 </c:when>
			</c:choose>
		</td>
	</tr>
	<form action="resultList.do">
		<tr>
			<td>
				<input type="hidden" name="code" value="${dto.code}"}/>
				<input type="submit" value="응시결과 보기"/>
			</td>
		</tr>
	</form>	
</table>
