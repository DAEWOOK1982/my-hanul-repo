...
--최근입사일자, 최초입사일자 조회 --3
SELECT  e.department_id, COUNT(*) cnt, SUM(salary) sum_sal, 
        ROUND(AVG(salary), 2) avg_sal, MAX(salary) max_sal, MIN(salary) min_sal,
...
SELECT  e.job_id, COUNT(*) cnt, ROUND(AVG(salary),2) avg_sal,
