...
<div align="center">
<h3>[답글 작성]</h3>
<form action="boardReplyAction.bo" method="post" onsubmit="return fnSubmit()" onreset="return fnReset()">
...
<table border="1">
	...
	<tr>
		<th>제목</th>
		<td><input type="text" name="board_subject" value="${id}님의 답글"/></td>
	</tr>
	<tr>
		<th>내용</th>
